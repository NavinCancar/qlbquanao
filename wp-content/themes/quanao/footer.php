            ...
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                            class="text-primary font-weight-bold border border-white px-3 mr-1">FANCY</span>Shop</h1>
                </a>
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trần Quang Khải, Ninh Kiều,
                    CT.</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>fancy05@gmail.com</p>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="cart.html"><i class="fa fa-angle-right mr-2"></i>Giỏ
                                hàng</a>
                            <a class="text-dark mb-2" href="checkout.html"><i class="fa fa-angle-right mr-2"></i>trang
                                cá nhân</a>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            <div class="form-group">
                                <input type="text" class="form-control border-0 py-4" placeholder="Họ và tên"
                                    required="required" />
                            </div>
                            <div class="form-group">
